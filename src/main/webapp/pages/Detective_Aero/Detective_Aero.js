Application.$controller("Detective_AeroPageController", ["$scope", function($scope) {
    "use strict";
    ...
    function addNextButtonListener() {
        $scope.Widgets.Aero_wizard.$element.find('[name=nextBtn_Aero_wizard]').click(function() {
            var activeStepEl = $scope.Widgets.Aero_wizard.$element.find('.app-wizard-step.current'),
    ...
    function addPrevButtonListener() {
        $scope.Widgets.Aero_wizard.$element.find('[name=previousBtn_Aero_wizard]').click(function() {
            var activeStepEl = $scope.Widgets.Aero_wizard.$element.find('.app-wizard-step.current'),
                parent = activeStepEl.parent(),
                noOfSteps = parent.find('.app-wizard-step').length,
                eachStepWidth = parseInt(activeStepEl.css('width')),
