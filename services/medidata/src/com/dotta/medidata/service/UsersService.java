...
public interface UsersService {
    ...
    /*
     * Returns the associated sessionses for given Users id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Sessions instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<Sessions> findAssociatedSessionses(Integer id, Pageable pageable);

    /*
     * Returns the associated usersPatientses for given Users id.
     *
     * @param id value of id; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
