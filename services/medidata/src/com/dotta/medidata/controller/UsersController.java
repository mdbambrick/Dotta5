...
import com.dotta.medidata.service.UsersService;
...
public class UsersController {
    ...
    @ApiOperation(value = "Returns the matching Users with given unique key values.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Users getByUniqueKeyId(@PathVariable("id") int id) {
        LOGGER.debug("Getting Users with uniques key UniqueKeyId");
        return usersService.getByUniqueKeyId(id);
    }
    ...
    @RequestMapping(value="/{id:.+}/sessionses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the sessionses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Sessions> findAssociatedSessionses(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated sessionses");
        return usersService.findAssociatedSessionses(id, pageable);
    }
    ...
    public Page<UsersPatients> findAssociatedUsersPatientses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return usersService.findAssociatedUsersPatientses(id, pageable);
    }
